...
from sqlalchemy import Date, DateTime, ForeignKey, Integer, Numeric, String, Unicode, func
...
class Prisoner(Base):
    ...
    full_name: Mapped[str] = mapped_column("FullName", Unicode(100), nullable=False)
    ...
    crime_type: Mapped[str | None] = mapped_column("CrimeType", Unicode(100), nullable=True)
