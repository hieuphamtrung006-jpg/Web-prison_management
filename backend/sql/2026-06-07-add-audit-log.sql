...
-- ============================================================
-- TRIGGER: LaborAssignments
-- ============================================================
IF OBJECT_ID('dbo.trg_LaborAssignments_Audit', 'TR') IS NOT NULL
    DROP TRIGGER dbo.trg_LaborAssignments_Audit;
GO
...
PRINT 'Trigger trg_LaborAssignments_Audit created.';
